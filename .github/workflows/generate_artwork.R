...
artwork <- switch(type,
  ...
  "33" = canvas_swirls(colors = colorPalette("random-palette"), background = sample(c("black", "#fafafa", "#fc7c7c", "#cc7722", "#a9d2c3"), 1), iterations = sample(500:5000, 1), n = sample(500:5000, 1))
)
